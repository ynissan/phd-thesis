...
\begin{table}[hp]
\centering
\caption{\label{tab:DataSamples}Data sets collected from three years of data-taking. All \lint are listed in \fbinv and are calculated using the BRIL Work Suite \cite{bril}.}
